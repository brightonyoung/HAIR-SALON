!function(e, t, n, r, o) {
    ...
    function we(n, r, o) {
        var i;
        o = void 0 === o ? {} : o,
        "function" == typeof e.CustomEvent ? i = new CustomEvent(r,{
            detail: o
        }) : (i = t.createEvent("CustomEvent")).initCustomEvent(r, !0, !0, o),
        n.dispatchEvent(i)
    }
    function ye(e, t) {
    ...
    function(K, re) {
        ...
        if (!G(W("html"), l)) {
            ...
            var Pe, Ie, Ce, Oe, Fe = !1, Me = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), Be = "ontouchstart"in e || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, De = "string" == typeof K ? W(K)[0] : K, Ue = q(), He = !1, Ne = !0, Xe = !0, je = [], ze = {
                m: {
                    up: !0,
                    down: !0,
                    left: !0,
            ...
            ze.k = Y({}, ze.m);
            var $e, We, Ye, Ge, qe, Ve, Ke, Qe = e.PointerEvent ? {
                down: "pointerdown",
                move: "pointermove"
            } : {
                down: "MSPointerDown",
            ...
            }, Ze = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]', et = !1;
            try {
                ...
                e.addEventListener("testPassive", null, tt),
                e.removeEventListener("testPassive", null, tt)
            } catch (e) {}
            var nt, rt = Y({}, re), ot = !1, it = !0;
            $n(),
            e.fp_easings = Y(e.fp_easings, {
                easeInOutCubic: function(e, t, n, r) {
                    return (e /= r / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e + 2) + t
                }
            }),
            De && (Le.version = "3.0.5",
            Le.setAutoScrolling = gt,
            Le.setRecordHistory = mt,
            Le.setScrollingSpeed = Et,
            Le.setFitToSection = bt,
            Le.setLockAnchors = function(e) {
                re.lockAnchors = e
            }
            ,
            Le.setMouseWheelScrolling = xt,
            Le.setAllowScrolling = Tt,
            Le.setKeyboardScrolling = yt,
            Le.moveSectionUp = St,
            Le.moveSectionDown = At,
            Le.silentMoveTo = Rt,
            Le.moveTo = Lt,
            Le.moveSlideRight = _t,
            Le.moveSlideLeft = kt,
            Le.fitToSection = Xt,
            Le.reBuild = Pt,
            Le.setResponsive = It,
            Le.getFullpageData = function() {
                return re
            }
            ,
            Le.destroy = function(n) {
                ...
                e.removeEventListener("hashchange", fn),
                e.removeEventListener("resize", wn),
                t.removeEventListener("keydown", hn),
                t.removeEventListener("keyup", pn),
                ...
                clearTimeout(Ye),
                n && (Nn(0),
                W("img[data-src], source[data-src], audio[data-src], iframe[data-src]", De).forEach(function(e) {
                    rn(e, "src")
                }),
                ...
                W(v + ", " + _).forEach(function(e) {
                    re.scrollOverflowHandler && re.scrollOverflow && re.scrollOverflowHandler.remove(e),
                    se(e, F + " " + c + " " + f);
                    var t = e.getAttribute("data-fp-styles");
                    t && e.setAttribute("style", e.getAttribute("data-fp-styles")),
                    G(e, p) && !ot && e.removeAttribute("data-anchor")
                }),
                An(De),
                [E, O, I].forEach(function(e) {
            ...
            e.fullpage_api = Le,
            re.$ && (re.$.fn.fullpage = Le),
            re.css3 && (re.css3 = function() {
                ...
                o)
                    void 0 !== r.style[i] && (r.style[i] = "translate3d(1px,1px,1px)",
                    n = e.getComputedStyle(r).getPropertyValue(o[i]));
                return t.body.removeChild(r),
            ...
            function() {
                ...
                Ue = q(),
                se(De, a),
                le(W(re.sectionSelector, De), p),
                le(W(re.slideSelector, De), L);
                for (var e = W(v), r = 0; r < e.length; r++) {
                    ...
                    Bt(i, o),
                    Dt(i, o),
                    u > 0 ? Mt(i, s, u) : re.verticalCentered && _n(i)
                }
                ...
                re.navigation && function() {
                    ...
                    ce(e, me);
                    var r = W(w)[0];
                    le(r, "fp-" + re.navigationPosition),
                    re.showActiveTooltip && le(r, A);
                    for (var o = "", i = 0; i < W(v).length; i++) {
                        var a = "";
                        re.anchors.length && (a = re.anchors[i]),
                        o += '<li><a href="#' + a + '"><span class="fp-sr-only">' + Ut(i, "Section") + "</span><span></span></a>";
                        var l = re.navigationTooltips[i];
                        void 0 !== l && "" !== l && (o += '<div class="' + y + " fp-" + re.navigationPosition + '">' + l + "</div>"),
                        o += "</li>"
                    }
                    W("ul", r)[0].innerHTML = o,
                    V(W(w), {
                ...
                W('iframe[src*="youtube.com/embed/"]', De).forEach(function(e) {
                    ...
                    t.setAttribute("src", r + (/\?/.test(r) ? "&" : "?") + n)
                }),
                re.scrollOverflow && ($e = re.scrollOverflowHandler.init(re))
            }(),
            Tt(!0),
            wt(!0),
            gt(re.autoScrolling, "internal"),
            yn(),
            Dn(),
            "complete" === t.readyState && un(),
            e.addEventListener("load", un),
            re.scrollOverflow || Ht(),
            e.addEventListener("scroll", Nt),
            e.addEventListener("hashchange", fn),
            e.addEventListener("blur", En),
            e.addEventListener("resize", wn),
            t.addEventListener("keydown", hn),
            t.addEventListener("keyup", pn),
            ["click", "touchstart"].forEach(function(e) {
        ...
        function gt(e, t) {
            ...
            mt(!!re.autoScrolling && rt.recordHistory, "internal"),
            V(De, {
                "-ms-touch-action": "",
                "touch-action": ""
            }),
        ...
        function xt(n) {
            ...
            De.addEventListener("mousedown", vn),
            De.addEventListener("mouseup", gn)) : (t.addEventListener ? (t.removeEventListener("mousewheel", qt, !1),
            t.removeEventListener("wheel", qt, !1),
            t.removeEventListener("MozMousePixelScroll", qt, !1)) : t.detachEvent("onmousewheel", qt),
            De.removeEventListener("mousedown", vn),
            De.removeEventListener("mouseup", gn))
        }
        function Tt(e, t) {
        ...
        function wt(e) {
            ...
            function() {
                if (Me || Be) {
                    ...
                    e.removeEventListener(Je.touchstart, Yt),
                    e.removeEventListener(Je.touchmove, $t, {
                        passive: !1
                    }),
                    e.addEventListener(Je.touchstart, Yt),
                    e.addEventListener(Je.touchmove, $t, {
                        passive: !1
                    })
                }
            }()) : (xt(!1),
        ...
        function yt(e, t) {
            ...
            re.keyboardScrolling = e)
        }
        function St() {
            var e = Q(W(g)[0], v);
            e || !re.loopTop && !re.continuousVertical || (e = te(W(v))),
            null != e && Qt(e, null, !0)
        }
        function At() {
            var e = J(W(g)[0], v);
            e || !re.loopBottom && !re.continuousVertical || (e = W(v)[0]),
            null != e && Qt(e, null, !1)
        }
        function Rt(e, t) {
            Et(0, "internal"),
            Lt(e, t),
            Et(rt.scrollingSpeed, "internal")
        }
        function Lt(e, t) {
            var n = In(e);
        ...
        function Pt(t) {
            if (!G(De, a)) {
                ...
                s && Rt(s + 1),
                He = !1,
                Te(re.afterResize) && t && re.afterResize.call(De, e.innerWidth, e.innerHeight),
                Te(re.afterReBuild) && !t && re.afterReBuild.call(De)
            }
        }
        function It(e) {
            var t = G(me, o);
            ...
            oe(W(w)),
            le(me, o),
            Te(re.afterResponsive) && re.afterResponsive.call(De, e),
            re.scrollOverflow && $e.createScrollBarForAll()) : t && (gt(rt.autoScrolling, "internal"),
            bt(rt.autoScrolling, "internal"),
            ie(W(w)),
            se(me, o),
            Te(re.afterResponsive) && re.afterResponsive.call(De, e))
        }
        function Ct(e) {
            ...
            .call(t, e) : pe(t, re.menu + " [data-menuanchor]") && function(e) {
                !W(re.menu)[0] || !re.lockAnchors && re.anchors.length || (xe(e),
                Lt(this.getAttribute("data-menuanchor")))
            }
            .call(t, e)
        }
        function Ot(e, n) {
            t["fp_" + e] = n,
            t.addEventListener(e, Ft, !0)
        }
        function Ft(e) {
            e.target != t && ("touchend" === e.type && (it = !1,
            setTimeout(function() {
                it = !0
            }, 800)),
            ("mouseenter" !== e.type || it) && re.normalScrollElements.split(",").forEach(function(n) {
        ...
        function Mt(e, n, r) {
            ...
            r > 1 && (re.controlArrows && function(e) {
                ...
                ve(W(I, e)[0], t),
                "#fff" !== re.controlArrowColor && (V(W(z, e), {
            ...
            re.slidesNavigation && function(e, t) {
        ...
        function Dt(e, t) {
            void 0 !== re.anchors[t] && G(e, c) && Rn(re.anchors[t], t),
            re.menu && re.css3 && null != pe(W(re.menu)[0], r) && W(re.menu).forEach(function(e) {
                me.appendChild(e)
            })
        }
        function Ut(e, t) {
        ...
        function Ht() {
            ...
            (!(e = In(dn().section)) || void 0 !== e && ne(e) === ne(Oe)) && Te(re.afterLoad) && Jt("afterLoad", {
                activeSection: null,
                element: t,
                direction: null,
        ...
        function Nt() {
            ...
            if (!re.autoScrolling || re.scrollBar) {
                ...
                n = W(g)[0].offsetTop,
                r = n + q(),
                ("up" == t ? r >= Ee() + q() : n <= Ee()) && (G(W(g)[0], f) || (le(W(g)[0], f),
                se(be(W(g)[0]), f))),
                !G(e = u[a], c)) {
                    at = !0;
                    var h, p, m = W(g)[0], E = ne(m, v) + 1, b = Ln(e), x = e.getAttribute("data-anchor"), T = ne(e, v) + 1, w = W(k, e)[0], y = {
                        activeSection: m,
                        sectionIndex: T - 1,
                        anchorLink: x,
                        element: e,
                    ...
                    Xe && (le(e, c),
                    se(be(e), c),
                    Te(re.onLeave) && Jt("onLeave", y),
                    Te(re.afterLoad) && Jt("afterLoad", y),
                    sn(m),
                    on(e),
                    an(e),
                    Rn(x, T - 1),
                    re.anchors.length && (Pe = x),
                    Fn(h, p, x)),
                    clearTimeout(qe),
                ...
                re.fitToSection && (clearTimeout(Ve),
            ...
            if (ze.m[e]) {
                ...
                if (re.scrollOverflow) {
                    var n = re.scrollOverflowHandler.scrollable(W(g)[0])
                      , r = "down" === e ? "bottom" : "top";
                    if (null != n) {
                        if (!re.scrollOverflowHandler.isScrolled(r, n))
                            return !0;
                        t()
                    } else
                        t()
        ...
        function $t(t) {
            ...
            if (Wt(t)) {
                ...
                ut = r.y,
                ft = r.x,
                W(I, n).length && Math.abs(ct - ft) > Math.abs(st - ut) ? !Fe && Math.abs(ct - ft) > e.innerWidth / 100 * re.touchSensitivity && (ct > ft ? ze.m.right && _t(n) : ze.m.left && kt(n)) : re.autoScrolling && Xe && Math.abs(st - ut) > e.innerHeight / 100 * re.touchSensitivity && (st > ut ? jt("down") : ut > st && jt("up"))
            }
        }
        function Wt(e) {
        ...
        function qt(t) {
            ...
            if (re.autoScrolling && !Ce && !r) {
                ...
                je.length > 149 && je.shift(),
                je.push(Math.abs(o)),
                re.scrollBar && xe(t);
                var s = n - dt;
                return dt = n,
                s > 200 && (je = []),
                Xe && Gt(je, 10) >= Gt(je, 70) && l && jt(i < 0 ? "down" : "up"),
                !1
            }
        ...
        function Vt(e, t) {
            ...
            if (!(null == r || Fe || W(_, r).length < 2)) {
                ...
                if (null == (i = "left" === e ? Q(o, _) : J(o, _))) {
                    if (!re.loopHorizontal)
                        return;
                    var a = be(o);
                    i = "left" === e ? a[a.length - 1] : a[0]
                }
                Fe = !Le.test.isTesting,
                xn(r, i, e)
            }
        }
        function Kt() {
            ...
            if (null != e) {
                var r, o, i = {
                    ...
                    dtop: function(e) {
                        ...
                        return t > Ue ? (o || a) && "bottom" !== a || (r = i) : (o || He && null == ee(e)) && (r = i),
                        ht = r,
                        r
                    }(e),
                    yMovement: Ln(e),
                ...
                if (!(i.activeSection == e && !He || re.scrollBar && Ee() === i.dtop && !G(e, b))) {
                    if (null != i.activeSlide && (r = i.activeSlide.getAttribute("data-anchor"),
                    o = ne(i.activeSlide)),
                    !i.localIsResizing) {
                        var a = i.yMovement;
                        if (void 0 !== n && (a = n ? "up" : "down"),
                        i.direction = a,
                        Te(re.onLeave) && !1 === Jt("onLeave", i))
                            return
                    }
                    ...
                    Pe = i.anchorLink,
                    Rn(i.anchorLink, i.sectionIndex)
                }
            }
        }
        function Jt(e, t) {
            ...
            if (re.v2compatible) {
                if (!1 === re[e].apply(r[0], r.slice(1)))
                    return !1
            } else if (we(De, e, r),
            !1 === re[e].apply(r[Object.keys(r)[0]], (n = r,
        ...
        function tn(t) {
            var n = {};
            return re.autoScrolling && !re.scrollBar ? (n.options = -t,
            n.element = W(r)[0]) : (n.options = t,
            n.element = e),
            n
        }
        function nn(e) {
            !function(e) {
                null != e.wrapAroundElements && (e.isMovementUp ? ge(W(v)[0], e.wrapAroundElements) : ve(W(v)[W(v).length - 1], e.wrapAroundElements),
                Nn(W(g)[0].offsetTop),
                Kt())
            }(e),
            Te(re.afterLoad) && !e.localIsResizing && Jt("afterLoad", e),
            re.scrollOverflow && re.scrollOverflowHandler.afterLoad(),
            e.localIsResizing || an(e.element),
            le(e.element, f),
            se(be(e.element), f),
            Xe = !0,
            Te(e.callback) && e.callback()
        }
        function rn(e, t) {
        ...
        function hn(e) {
            ...
            9 === r ? function(e) {
                ...
                )(e) || (r ? null == pe(r, g + "," + g + " " + k) && (r = i(e)) : i(e),
                (!n && r == o[o.length - 1] || n && r == o[0]) && xe(e))
            }(e) : ye(n, "textarea") || ye(n, "input") || ye(n, "select") || "true" === n.getAttribute("contentEditable") || "" === n.getAttribute("contentEditable") || !re.keyboardScrolling || !re.autoScrolling || ([40, 38, 32, 33, 34].indexOf(r) > -1 && xe(e),
            Ce = e.ctrlKey,
        ...
        function vn(e) {
            2 == e.which && (pt = e.pageY,
            De.addEventListener("mousemove", bn))
        }
        function gn(e) {
        ...
        function bn(e) {
            Xe && (e.pageY < pt && ze.m.up ? St() : e.pageY > pt && ze.m.down && At()),
            pt = e.pageY
        }
        function xn(e, t, n) {
            var r, o, i = pe(e, v), a = {
            ...
            a.xMovement = (r = a.prevSlideIndex,
            o = a.slideIndex,
            r == o ? "none" : r > o ? "left" : "right"),
            a.direction = a.direction ? a.direction : a.xMovement,
            a.localIsResizing || (Xe = !1),
            re.onSlideLeave && !a.localIsResizing && "none" !== a.xMovement && Te(re.onSlideLeave) && !1 === Jt("onSlideLeave", a) ? Fe = !1 : (le(t, c),
            se(be(t), c),
            a.localIsResizing || (sn(a.prevSlide),
            on(t)),
            !re.loopHorizontal && re.controlArrows && (Se(W(X, i), 0 !== a.slideIndex),
            Se(W(z, i), null != ee(t))),
            G(i, c) && !a.localIsResizing && Fn(a.slideIndex, a.slideAnchor, a.anchorLink, a.sectionIndex),
            function(e, t, n) {
                var r = t.destinyPos;
                if (re.css3) {
                    var o = "translate3d(-" + Math.round(r.left) + "px, 0px, 0px)";
                    Le.test.translate3dH[t.sectionIndex] = o,
                    V(Sn(W(O, e)), Xn(o)),
                    Ge = setTimeout(function() {
                        n && Tn(t)
                    }, re.scrollingSpeed)
                } else
                    Le.test.left[t.sectionIndex] = Math.round(r.left),
                    Wn(e, Math.round(r.left), re.scrollingSpeed, function() {
                        n && Tn(t)
                    })
            }(e, a, !0))
        }
        function Tn(e) {
            ...
            t = e.slidesNav,
            n = e.slideIndex,
            re.slidesNavigation && null != t && (se(W(u, t), c),
            le(W("a", W("li", t)[n]), c)),
            e.localIsResizing || (Te(re.afterSlideLoad) && Jt("afterSlideLoad", e),
            Xe = !0,
            an(e.destiny)),
            Fe = !1
        }
        ...
        function Rn(e, t) {
            var n;
            n = e,
            W(re.menu).forEach(function(e) {
                re.menu && null != e && (se(W(u, e), c),
                le(W('[data-menuanchor="' + n + '"]', e), c))
            }),
            function(e, t) {
                re.navigation && null != W(w)[0] && (se(W(u, W(w)[0]), c),
                le(e ? W('a[href="#' + e + '"]', W(w)[0]) : W("a", W("li", W(w)[0])[t]), c))
            }(e, t)
        }
        function Ln(e) {
            var t = ne(W(g)[0], v)
        ...
        function Fn(e, t, n, r) {
            var o = "";
            re.anchors.length && !re.lockAnchors && (e ? (null != n && (o = n),
            null == t && (t = e),
            Ie = t,
            Mn(o + "/" + t)) : null != e ? (Ie = t,
            Mn(n)) : Mn(n)),
        ...
        function Un(e) {
            ...
            Be && Wt(e) && re.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY,
        ...
        function $n() {
            ...
            ae ? e && e.length < 20 && (console.warn("%c This website was made using fullPage.js slider. More info on the following website:", t),
            console.warn("%c https://alvarotrigo.com/fullPage/", t)) : ($("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"),
            $("error", "https://github.com/alvarotrigo/fullPage.js#options.")),
            G(W("html"), l) ? $("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (re.continuousVertical && (re.loopTop || re.loopBottom) && (re.continuousVertical = !1,
            $("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
            !re.scrollOverflow || !re.scrollBar && re.autoScrolling || $("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"),
            !re.continuousVertical || !re.scrollBar && re.autoScrolling || (re.continuousVertical = !1,
            $("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
            re.scrollOverflow && null == re.scrollOverflowHandler && (re.scrollOverflow = !1,
            $("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")),
            ["fadingEffect", "continuousHorizontal", "scrollHorizontally", "interlockedSlides", "resetSliders", "responsiveSlides", "offsetSections", "dragAndMove", "scrollOverflowReset", "parallax", "cards"].forEach(function(e) {
            ...
            re.anchors.forEach(function(e) {
                ...
                (n.length || t.length) && ($("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE)."),
                n.length && $("error", '"' + e + '" is is being used by another element `id` property'),
                t.length && $("error", '"' + e + '" is is being used by another element `name` property'))
            }))
        }
        function Wn(t, n, r, o) {
            var i = function(t) {
            ...
            var s = function() {
                if (nt) {
                    var c = n;
                    l += 20,
                    r && (c = e.fp_easings[re.easing](l, i, a, r)),
                    Yn(t, c),
                    l < r ? setTimeout(s, 20) : void 0 !== o && o()
                } else
                    l < r && o()
            };
            s()
...
function(e, t) {
    ...
    function n(e, t, n) {
        function r(e, t) {
            ...
            if (i.shaderSource(n, t),
            i.compileShader(n),
            !i.getShaderParameter(n, i.COMPILE_STATUS))
                throw new Error("compile error: " + i.getShaderInfoLog(n));
            return n
        }
        var o = {};
        if (o.id = i.createProgram(),
        i.attachShader(o.id, r(i.VERTEX_SHADER, e)),
        i.attachShader(o.id, r(i.FRAGMENT_SHADER, t)),
        i.linkProgram(o.id),
        !i.getProgramParameter(o.id, i.LINK_STATUS))
            throw new Error("link error: " + i.getProgramInfoLog(o.id));
        o.uniforms = {},
        o.locations = {},
        i.useProgram(o.id),
        ...
        for (var a, l, s = /uniform (\w+) (\w+)/g, c = e + t; null != (a = s.exec(c)); )
            l = a[2],
            o.locations[l] = i.getUniformLocation(o.id, l);
        return o
    }
    function r(e, t) {
    ...
    var i, a = (e = e && "default"in e ? e.default : e)(window), l = function() {
        function e(e, t, r) {
        ...
        if (!(i = t.getContext("webgl") || t.getContext("experimental-webgl")))
            return null;
        var n = {};
        ...
        !n.OES_texture_float)
            return null;
        var r = [];
        r.push(e("float", i.FLOAT, Float32Array)),
        n.OES_texture_half_float && r.push(e("half_float", n.OES_texture_half_float.HALF_FLOAT_OES, null));
        ...
        for (var l = null, s = 0; s < r.length; s++)
            if (i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, 32, 32, 0, i.RGBA, r[s].type, null),
    ...
    var c = function(t, n) {
        ...
        this.context = i = o.getContext("webgl") || o.getContext("experimental-webgl"),
        ...
        for (var a = l.arrayType, s = a ? new a(this.resolution * this.resolution * 4) : null, c = 0; c < 2; c++) {
            ...
            i.bindFramebuffer(i.FRAMEBUFFER, f),
            i.bindTexture(i.TEXTURE_2D, u),
            i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, l.linearSupport ? i.LINEAR : i.NEAREST),
            i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, l.linearSupport ? i.LINEAR : i.NEAREST),
            i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE),
            i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE),
            i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, this.resolution, this.resolution, 0, i.RGBA, l.type, s),
    ...
    c.prototype = {
            ...
            if (t != this.imageSource)
                ...
                this.imageSource) {
                    ...
                    n.onload = function() {
                        ...
                        i.bindTexture(i.TEXTURE_2D, e.backgroundTexture),
                        i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_S, r),
                        i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_T, r),
        ...
        drawQuad: function() {
            i.bindBuffer(i.ARRAY_BUFFER, this.quad),
            i.vertexAttribPointer(0, 2, i.FLOAT, !1, 0, 0),
        ...
        render: function() {
            ...
            i.useProgram(this.renderProgram.id),
            r(this.backgroundTexture, 0),
            r(this.textures[0], 1),
            i.uniform1f(this.renderProgram.locations.perturbance, this.perturbance),
            i.uniform2fv(this.renderProgram.locations.topLeft, this.renderProgram.uniforms.topLeft),
            i.uniform2fv(this.renderProgram.locations.bottomRight, this.renderProgram.uniforms.bottomRight),
            i.uniform2fv(this.renderProgram.locations.containerRatio, this.renderProgram.uniforms.containerRatio),
            i.uniform1i(this.renderProgram.locations.samplerBackground, 0),
            i.uniform1i(this.renderProgram.locations.samplerRipples, 1),
            this.drawQuad(),
            i.disable(i.BLEND)
        },
        update: function() {
            i.viewport(0, 0, this.resolution, this.resolution),
            i.bindFramebuffer(i.FRAMEBUFFER, this.framebuffers[this.bufferWriteIndex]),
            r(this.textures[this.bufferReadIndex]),
            i.useProgram(this.updateProgram.id),
            this.drawQuad(),
        ...
        computeTextureBoundaries: function() {
            var e, n = this.$el.css("background-size"), r = this.$el.css("background-attachment"), o = function(e) {
                var t = e.split(" ");
                if (1 !== t.length)
            ...
            e.height = a.height()) : ((e = this.$el.offset()).width = this.$el.innerWidth(),
            e.height = this.$el.innerHeight()),
            "cover" == n)
                var i = Math.max(e.width / this.backgroundWidth, e.height / this.backgroundHeight)
                  , l = this.backgroundWidth * i
                  , s = this.backgroundHeight * i;
            else if ("contain" == n)
                i = Math.min(e.width / this.backgroundWidth, e.height / this.backgroundHeight),
                l = this.backgroundWidth * i,
                s = this.backgroundHeight * i;
            else {
                l = (n = n.split(" "))[0] || "",
                s = n[1] || l;
                t(l) ? l = e.width * parseFloat(l) / 100 : "auto" != l && (l = parseFloat(l)),
                t(s) ? s = e.height * parseFloat(s) / 100 : "auto" != s && (s = parseFloat(s)),
                "auto" == l && "auto" == s ? (l = this.backgroundWidth,
                s = this.backgroundHeight) : ("auto" == l && (l = this.backgroundWidth * (s / this.backgroundHeight)),
                "auto" == s && (s = this.backgroundHeight * (l / this.backgroundWidth)))
            }
            var c = o[0]
              , u = o[1];
            c = t(c) ? e.left + (e.width - l) * parseFloat(c) / 100 : e.left + parseFloat(c),
            u = t(u) ? e.top + (e.height - s) * parseFloat(u) / 100 : e.top + parseFloat(u);
            var f = this.$el.offset();
            this.renderProgram.uniforms.topLeft = new Float32Array([(f.left - c) / l, (f.top - u) / s]),
            this.renderProgram.uniforms.bottomRight = new Float32Array([this.renderProgram.uniforms.topLeft[0] + this.$el.innerWidth() / l, this.renderProgram.uniforms.topLeft[1] + this.$el.innerHeight() / s]);
        ...
        initShaders: function() {
            ...
            i.uniform2fv(this.updateProgram.locations.delta, this.textureDelta),
        ...
        initTexture: function() {
            this.backgroundTexture = i.createTexture(),
            i.bindTexture(i.TEXTURE_2D, this.backgroundTexture),
        ...
        drop: function(e, t, n, o) {
            ...
            i.bindFramebuffer(i.FRAMEBUFFER, this.framebuffers[this.bufferWriteIndex]),
            r(this.textures[this.bufferReadIndex]),
            i.useProgram(this.dropProgram.id),
            i.uniform2fv(this.dropProgram.locations.center, c),
            i.uniform1f(this.dropProgram.locations.radius, n),
            i.uniform1f(this.dropProgram.locations.strength, o),
            this.drawQuad(),
            this.swapBufferIndices()
        },
        updateSize: function() {
    ...
    e.fn.ripples = function(t) {
        ...
        return this.each(function() {
            var r = e(this)
              , o = r.data("ripples")
              , i = e.extend({}, c.DEFAULTS, r.data(), "object" == typeof t && t);
